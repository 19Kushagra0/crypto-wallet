      ...
      <main className={styles.main}>
        ...
        <section className={styles.hero}>
          <div className={styles.heroContent}>
            ...
            <h1 className={styles.heroBalance}>$124,592.00</h1>
            ...
            <div className={styles.activityList}>
              ...
              <div className={styles.activityItem}>
                <div className={styles.activityItemLeft}>
                  ...
                  <div>
                    <div className={styles.activityMainText}>Received ETH</div>
                ...
                <div className={styles.activityItemRight}>
                  <div className={styles.activityAmount}>+1.42 ETH</div>
                  <div className={styles.activitySubText}>Today, 14:23</div>
                </div>
              </div>
              ...
              <div className={styles.activityItem}>
                <div className={styles.activityItemLeft}>
                  ...
                  <div>
                    <div className={styles.activityMainText}>Sent USDC</div>
                    <div className={styles.activitySubText}>To 0x8A...3cD1</div>
                  </div>
                </div>
                <div className={styles.activityItemRight}>
                  <div className={styles.activityAmount}>-500.00 USDC</div>
                  <div className={styles.activitySubText}>Yesterday, 09:12</div>
                </div>
              </div>
              <div className={styles.activityDivider} />
              ...
              <div className={styles.activityItem}>
                <div className={styles.activityItemLeft}>
                  ...
                  <div>
                    ...
                    <div className={styles.activitySubText}>Via Uniswap</div>
                  </div>
                </div>
                <div className={styles.activityItemRight}>
                  <div className={styles.activityAmount}>0.5 BTC</div>
                  <div className={styles.activitySubText}>Oct 24, 11:45</div>
                </div>
              </div>
            </div>
          </div>
